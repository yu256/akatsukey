...
<div class="_gaps_m">
	...
	<FormSection>
		<div class="_gaps_m">
			...
			<MkSwitch v-model="compressHighQuality">
				<template #label>{{ i18n.ts.compressHighQuality }}</template>
				<template #caption>{{ i18n.ts.compressHighQualityDescription }}</template>
			</MkSwitch>
...
const compressHighQuality = computed(defaultStore.makeGetterSetter('compressHighQuality'));
